...
import AnswerMissionMobile from "@/components/freelance/AnswerMissionMobile";
  ...
  return (
    <Suspense fallback={<Loading />}>
      ...
      <main className="flex flex-col items-center justify-between  mt-32">
        <FreelanceIntroSection firstTitle="Appel d'offres" />
        ...
        <div className="flex flex-col justify-between w-full mt-10 main-content">
          ...
          <div className="display-tablet-mobile">
            <AnswerMissionMobile mission={mission} freelance={freelance} />
          </div>
        </div>
      </main>
    </Suspense>

  ...
  return (
    <main className="flex flex-col items-center justify-between">
      ...
      <h1 className="text-5xl text-center text-bold my-20">
        Vos avantages en tant que entreprise cliente
      </h1>
      <div className="flex justify-between px-20 demarche-section flex-row-reverse">
        <div className="w-6/12 mt-20">
          ...
          <p className="text-xl leading-relaxed">
            La démarche liée aux obligations sociales et fiscales est à notre
            charge. <br />
            <span style={{ color: "#9ABF7A" }} className="mr-2">Pas de surprises:</span>
            vous négociez vous-même le tarif de la prestation et vous établissez
            les termes du contrat avec l’indépendant.
          </p>
        </div>
        <div>
      ...
      <div className="flex justify-between px-20 flex-row-reverse partenaire-section py-5">
        <div className="w-6/12 mt-40">
          ...
          <p className="text-xl leading-relaxed">
            ...
            Main dans la main, nous vous accompagnons sur la mise en place de
            CONNECT au sein de votre entreprise.
          </p>
        </div>
        <div>
          <Image
      ...
      <div className="flex justify-between px-20 mission-section mb-10 w-full">
        <div className="w-6/12 mt-10">
          ...
          <p className="text-xl leading-relaxed">
            Nous vous accompagnons dans la partie contractuelle et nous mettons
            en place la mission en très peu de temps. Le contrat est signé,
      ...
      <div className="flex justify-between px-20 opportunity-section mb-10 w-full py-10">
        <div className="w-6/12 mt-20">
          ...
          <p className="text-xl leading-relaxed">
            ...
            Nous vous cherchons un profil qui connecte avec la mission demander.

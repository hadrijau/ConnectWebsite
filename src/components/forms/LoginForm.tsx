    ...
    <div className="w-full">
      ...
      >
        <Form>
          ...
          <button className="flex items-center justify-center py-2 mt-10 submit-button w-full rounded" type="submit">
            <Image
            ...
            />
            <span className="text-white text-bold text-sm ml-2">Connection</span>
          </button>
        </Form>
      </Formik>
      </div>

...
const Navbar = () => {
  ...
  if (path.startsWith('/independant')) {
    ...
    background = "linear-gradient(91.53deg, rgba(216, 146, 192, 0.6) 3.67%, rgba(185, 211, 134, 0.6) 100%)"
  } else {
    background ="linear-gradient(91.53deg, rgba(216, 146, 192, 0.6) 3.67%, rgba(58, 142, 186, 0.6) 100%)"
  }
  ...
  return (
    <nav className="flex justify-between items-center px-10 pt-4">
      ...
      {path.startsWith("/entreprise") && (
        <div style={{ background: "#D892C0" }} className="py-2 px-10 rounded-lg">
